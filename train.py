...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/Apex.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default='G:/yolo5/runs/train/exp4/weights/last.pt',
